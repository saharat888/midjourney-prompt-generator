document.addEventListener('DOMContentLoaded', () => {
    ...
    const promptTemplates = {
        ...
        whitebackground: "You are an expert in designing prompts for Midjourney v7. I would like you to help me create prompts for professional photography - specifically full product shots isolated on clean white backgrounds, photography for transparent backgrounds, camera settings and lens characteristics, lighting setups (studio, natural, dramatic), composition arrangements, lighting details, image dimensions –ar 1:1, 3:4, 3:2, and defining the necessary technical parameters for v7.",
        custom: ""
    };
